...
inline static void *
getSectionPtr(ClObjectHdr * hdr, ClSection * s)
{
  if (IsMallocedMax(s->max))
    return s->sectionPtr;
  return (void *) ((char *) hdr + s->sectionOffset);
}

inline static int
isMallocedSection(ClSection * s)
{
  return IsMallocedMax(s->max);
}

inline static void
setSectionOffset(ClSection * s, long offs)
{
...
inline static void *
setSectionPtr(ClSection * s, void *ptr)
{
  s->max |= 0x8000;
...
{
  if (hdr->flags & HDR_StrBufferMalloced)
    return hdr->strBuffer;
  return (ClStrBuf *) ((char *) hdr + hdr->strBufOffset);
}

inline static ClStrBuf *
setStrBufPtr(ClObjectHdr * hdr, void *buf)
{
...
inline static void
setStrBufOffset(ClObjectHdr * hdr, long offs)
{
  hdr->flags &= ~HDR_StrBufferMalloced;
...
inline static int *
setStrIndexPtr(ClStrBuf * buf, void *idx)
{
  buf->iMax |= 0x8000;
...
inline static void
setStrIndexOffset(ClObjectHdr * hdr, ClStrBuf * buf, long offs)
{
  buf->iMax &= 0x7fff;
...
{
  if (hdr->flags & HDR_ArrayBufferMalloced)
    return hdr->arrayBuffer;
  else
    return (ClArrayBuf *) ((char *) hdr + hdr->arrayBufOffset);
}

inline static ClArrayBuf *
setArrayBufPtr(ClObjectHdr * hdr, void *buf)
{
...
inline static void
setArrayBufOffset(ClObjectHdr * hdr, long offs)
{
  hdr->flags &= ~HDR_ArrayBufferMalloced;
...
inline static int *
setArrayIndexPtr(ClArrayBuf * buf, void *idx)
{
  buf->iMax |= 0x8000;
  return buf->indexPtr = (int *) idx;
}
...
inline static void
setArrayIndexOffset(ClObjectHdr * hdr, ClArrayBuf * buf, long offs)
{
  buf->iMax &= 0x7fff;
  buf->indexPtr = (int *) (((char *) hdr) + offs);
  buf->indexOffset = offs;
...
inline static int
isMallocedStrIndex(ClStrBuf * buf)
{
  return IsMallocedMax(buf->iMax);
}

inline static int
isMallocedArrayBuf(ClObjectHdr * hdr)
{
  return hdr->flags & HDR_ArrayBufferMalloced;
}

inline static int
isMallocedArrayIndex(ClArrayBuf * buf)
{
  return IsMallocedMax(buf->iMax);
}
