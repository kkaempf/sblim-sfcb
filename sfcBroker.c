...
static void
addStartedThreadAdapter(pthread_t tid)
{

  StartedThreadAdapter *sa =
      (StartedThreadAdapter *) malloc(sizeof(StartedThreadAdapter));
...
static int
testStartedThreadAdapter(pthread_t tid, int *left)
{
