...
void
memLinkObjectPath(CMPIObjectPath * cop)
{
...
const char     *
opGetClassNameChars(const CMPIObjectPath * op)
{
  ClObjectPath   *cop = (ClObjectPath *) op->hdl;
...
const char     *
opGetNameSpaceChars(const CMPIObjectPath * op)
{
  ClObjectPath   *cop = (ClObjectPath *) op->hdl;
...
unsigned long
getObjectPathSerializedSize(const CMPIObjectPath * op)
{
  ClObjectPath   *cop = (ClObjectPath *) op->hdl;
...
void
getSerializedObjectPath(const CMPIObjectPath * op, void *area)
{
...
CMPIObjectPath *
relocateSerializedObjectPath(void *area)
{
...
MsgSegment
setObjectPathMsgSegment(const CMPIObjectPath * op)
{
  MsgSegment      s;
...
static void
addKey(CMPIObjectPath * op, char *kd, int ref)
{
  char           *val = strchr(kd, '=');
  *val = 0;
  val++;
...
CMPIObjectPath *
getObjectPath(char *path, char **msg)
{
  char           *p,
                 *pp,
                 *last,
...
UtilStringBuffer *
normalizeObjectPathStrBuf(const CMPIObjectPath * cop)
{
...
char           *
normalizeObjectPathChars(const CMPIObjectPath * cop)
{
...
char           *
normalizeObjectPathCharsDup(const CMPIObjectPath * cop)
{
  char           *n;
  UtilStringBuffer *sb = normalizeObjectPathStrBuf(cop);
...
int
objectpathCompare(const CMPIObjectPath * cop1, const CMPIObjectPath * cop2)
{
  UtilStringBuffer *sb1,
                 *sb2;
  int             result;
