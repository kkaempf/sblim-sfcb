...
/*
 * $Id: sfcbdump.c,v 1.6 2009/12/22 00:18:29 buccella Exp $
 *
...
static int
dumpStringBuffer(const ClObjectHdr * hdr, const char *prefix)
{
  /*
   * check offset range 
   */
...
static int
dumpArrayBuffer(const ClObjectHdr * hdr, const char *prefix)
{
  /*
   * check offset range 
   */
...
static int
dumpProperties(const ClClass * cls, const char *prefix)
{
  /*
   * check offset range 
   */
...
static int
dumpQualifiers(const ClClass * cls, const char *prefix)
{
  /*
   * check offset range 
   */
...
static int
dumpMethods(const ClClass * cls, const char *prefix)
{
  /*
   * check offset range 
   */
